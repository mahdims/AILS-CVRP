...
```console
java -jar AILSII.jar -file data/Vrp_Set_X/X-n214-k11.vrp -rounded true -best 10856 -limit 100 -stoppingCriterion Time 
```
...
**-solutionDir** : Directory path where solution files (.sol) will be saved in CVRPLIB format. If not specified, solutions will not be saved to files. The default is no output directory.
